...
namespace Server
{
	...
	enum class PacketType
	{
		...
		SpawnEnemy, //Takes sf::Int32 with the type of the enemy and two float values with the position
		...
		MissionSuccess //This no arguments. It is just used to tell the client that the game is over
	};
}
